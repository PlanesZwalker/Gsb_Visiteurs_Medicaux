 ...
 * @author passpass
 */
public class UtilisateurModif extends javax.swing.JFrame {

    /**
     * Creates new form UtilisateurAdd
     */
    public UtilisateurModif() {
               ...
               *    Cas où les saisies concernant le visiteur sont valides
                ...
                if (validVisiteur) {
                    ...
                    *   on modifie l'utilisateur associé au profil du visiteur séléctionné
                     */
                    modifUser = monNewUserC.editUser(monlogin, monmotdepasse, monemail, role, id_utilisateur);
    ...
    *   Le RadioButton du visiteur subit une interaction
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UtilisateurModif.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UtilisateurModif().setVisible(true);
            }
        });
    }
